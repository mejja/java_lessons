/**
 * Demonstrates the use of a generic SafeImpl class with Banana objects.
 */
public class GenericMain {

    public static void main(String[] args) {

        // Create five Banana instances
        ...
        // Create a generic SafeImpl that stores Banana objects
        SafeImpl<Banana> safe = new SafeImpl<>();

        // Add all Banana instances to the safe
        safe.lockIn(banana1);
        safe.lockIn(banana2);
        safe.lockIn(banana3);
        safe.lockIn(banana4);
