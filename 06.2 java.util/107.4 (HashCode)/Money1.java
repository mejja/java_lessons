public class Money1 {
    ...
    @Override
    public int hashCode() {
        // Multiply amount by 100 and add it to the hash code of the currency
        int currencyHashCode = (currency != null) ? currency.hashCode() : 0;
        return 31 * currencyHashCode + (amount * 100);
    }
}
